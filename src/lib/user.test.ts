...
describe('parseUser', () => {
  it('Parse', () => {
    ...
    expect(profile.imageOriginal).toBe('https://example.com/original.png')
    expect(profile.isCustomImage).toBeTruthy()
    expect(profile.email).toBe('test@example.com')
    expect(profile.firstName).toBe('test')
    expect(profile.lastName).toBe('')
    expect(profile.image24).toBe('https://example.com/24.png')
    expect(profile.image32).toBe('https://example.com/32.png')
    expect(profile.image48).toBe('https://example.com/48.png')
    expect(profile.image72).toBe('https://example.com/72.png')
    expect(profile.image192).toBe('https://example.com/192.png')
    expect(profile.image512).toBe('https://example.com/512.png')
    expect(profile.image1024).toBe('https://example.com/1024.png')
